`timescale 1ns / 1ps
//==============================================================================
// AES S-box Lookup Module (Distributed LUT ROM)
// PS06 AES-128 AXI-MM Hardware Accelerator — VELTRAXX '26
//==============================================================================
// Implements the official NIST Rijndael forward S-box as a distributed ROM
...
// into 4 LUT6 primitives + MuxF7/F8, achieving optimal ~32 LUTs per 8-bit S-Box.
//==============================================================================
